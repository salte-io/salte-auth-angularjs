...
// ----------------------------------------------------------------------
'use strict';
/* Directive tells eslint that it, describe are globals defined by jasmine */
/* global Logging */
...
describe('StateCtrl', function() {
  var $httpBackend, adalServiceProvider, rootScope, location, $templateCache, $stateParams;

  // mock Application to allow us to inject our own dependencies
  beforeEach(angular.mock.module('StateApplication'));

  // mock the controller for the same reason and include $scope and $controller
  beforeEach(angular.mock.inject(function(_adalAuthenticationService_, _$rootScope_, _$httpBackend_, _$location_, _$templateCache_, _$stateParams_) {
    adalServiceProvider = _adalAuthenticationService_;
    rootScope = _$rootScope_;
    $httpBackend = _$httpBackend_;
    location = _$location_;
